...
const HomePage = ({ isLoggedIn, userId, selectedCategory }) => {
  ...
  // discountedProductsRate is an array of products that are discounted by rate
  // discountedProductsEndDate is an array of products that are discounted by end date
  ...
  return (
    <Container maxWidth="lg" sx={{ padding: "20px" }}>
      ...
      {discountedProductsRate.length > 0 || discountedProductsEndDate.length > 0 ? (
        <Box sx={{ marginTop: "30px", marginBottom: "30px", height: "600px" }}>
          <Carousel
            ...
            sx={{ minHeight: "400px" }}
          >
            {discountedProductsRate.length > 0 && (
              <Box
                sx={{
                  minHeight: "500px",
                  height: "100%",
            ...
            {discountedProductsEndDate.length > 0 && (
              <Box
                sx={{
                  minHeight: "500px",
                  height: "100%",
